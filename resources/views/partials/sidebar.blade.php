...
{{--                    <i class="bx bx-list-ol"></i>--}}
{{--                    <span key="t-dashboards">რეპორტები</span>--}}
{{--                </a>--}}
{{--                <ul class="sub-menu" aria-expanded="false">--}}
{{--                    <li><a href="{{ route('admin.reports.finances') }}" key="t-default">ფინანსები</a></li>--}}
{{--                    <li><a href="{{ route('admin.reports.users') }}" key="t-default">მომხმარებლები</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
...
{{--                <li><a href="{{ route('roles.index') }}" key="t-default">უფლებები</a></li>--}}
{{--                <li><a href="{{ route('settings.forestry_administrations.index') }}" key="t-default">სატყეო ადმინისტრაციები</a></li>--}}
{{--                <li><a href="{{ route('settings.forest_categories.index') }}" key="t-default">ტყის კატეგორიები</a></li>--}}
{{--            </ul>--}}
{{--        </li>--}}
{{--        <li>--}}
{{--            <a href="javascript: void(0);" class="has-arrow waves-effect">--}}
